using HotelProject.WebUI.Dtos.SocialFollowersDtos;
using Microsoft.AspNetCore.Mvc;
using Newtonsoft.Json;

namespace HotelProject.WebUI.ViewComponents.Dashboard._DashboardSocialFollowersCountPartial
{
    public class _DashboardSocialFollowersCountPartial : ViewComponent
    {
	...
	//			RequestUri = new Uri("https://instagram-profile1.p.rapidapi.com/getprofile/wwe/"),
	//			Headers =
	//{
	...
	//},
	//		};
	//		using (var response = await instagramClient.SendAsync(instagramRequest))
	//		{
	...
	//			ViewBag.instagramUsername = resultInstagramFollowersDtos.username;
	//		}
